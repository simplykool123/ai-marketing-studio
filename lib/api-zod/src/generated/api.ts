...
export const ListPostsResponseItem = zod.object({
  ...
  clientId: zod.string(),
  campaignId: zod.string().optional(),
  sourceAiIdeaId: zod.string().optional(),
  contentType: zod.string().optional(),
  contentSchema: zod.unknown().optional(),
  contentSchemaVersion: zod.number().optional(),
  skillId: zod.string().optional(),
  storylineId: zod.string().optional(),
  qualityScore: zod.number().optional(),
  qualityReport: zod.unknown().optional(),
  generationMetadata: zod.unknown().optional(),
  editHistory: zod.unknown().optional(),
  memoryRefs: zod.array(zod.string()).optional(),
  topic: zod.string(),
  caption: zod.string(),
  hashtags: zod.string().optional(),
  selectedImageUrl: zod.string().optional(),
  originalImageUrl: zod.string().optional(),
  brandedImageUrl: zod.string().optional(),
  status: zod.enum([
    "draft",
    "in_review",
    "approved",
